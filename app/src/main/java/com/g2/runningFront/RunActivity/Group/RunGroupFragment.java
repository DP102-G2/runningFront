...
public class RunGroupFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button btLast=view.findViewById(R.id.gp_btLast);

        btLast.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(v).navigate(R.id.action_runGroupFragment_to_nationalFragment);
            }
        });
            ...
            public MyViewHolder(View itemView) {                                                     //botton 追蹤or未追蹤
                ...
                btyes.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        switch (flag){
                           case 0:
                              btyes.setBackgroundDrawable(getResources()
                                      .getDrawable(R.drawable.bt_style));
                                flag = 1;
                                btyes.setText("追蹤");
                               break;
                           case 1:
                               btyes.setBackgroundDrawable(getResources()
                                       .getDrawable(R.drawable.nobt_style));
                               flag = 0;
                               btyes.setText("已追蹤");
                               break;
                       }
...
//
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            View itemView = LayoutInflater.from(context)
                    .inflate(R.layout.itern_view_group, parent, false);
